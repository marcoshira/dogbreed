...
const onInputSuccess = (theme: DefaultTheme, errorMessage: string) => css`
  border: ${theme.spacings.xxtiny} solid ${theme.colors.green};
  box-shadow: 0 0 ${theme.spacings.xtiny} 0 ${theme.colors.green};
  &:focus {
    border: ${theme.spacings.xxtiny} solid ${theme.colors.green};
    box-shadow: 0 0 ${theme.spacings.xtiny} 0 ${theme.colors.green};
  }
...
export const Input = styled.input<
  Pick<TextInputProps, 'errorMessage' | 'as' | 'type' | 'errorGreen'>
>`
  ${({ theme, errorMessage, errorGreen, as }) => css`
    ...
    &:focus {
      border: ${theme.spacings.xxtiny} solid ${theme.colors.thirdColor};
      box-shadow: 0 0 ${theme.spacings.xtiny} 0 ${theme.colors.thirdColor};
      background: ${theme.colors.white};
    }
    &:focus
      + ${Label},
    ...
    ${!!errorMessage && errorGreen && onInputSuccess(theme, errorMessage)}
  `}
`;
...
export const ErrorMessage = styled.p<ColorGreen>`
  ${({ theme, errorGreen }) => css`
    color: ${theme.colors.warning};
    margin: ${theme.spacings.xxsmall} 0 ${theme.spacings.large};
    ${errorGreen && colorGreen(theme)}
  `}
`;
